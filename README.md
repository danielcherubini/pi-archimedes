...
### 🔌 MCP ([`@pi-archimedes/mcp`](packages/mcp/))

Full MCP client adapter that connects pi to any MCP server with pi-native TUI rendering.
...
### [`@pi-archimedes/mcp`](packages/mcp/)
