 ...
 *   Tab characters are treated as literal text and will not be stripped.
 *   For best results, use spaces for indentation in code blocks.
 ...
 * - Lines with fewer leading spaces than `minIndent` are left unchanged.
 ...
 * - Mixed tab/space indentation produces unexpected results because tabs
 *   are not converted to spaces before computing `minIndent`.
 */
